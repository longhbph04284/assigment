...
<td runat="server" />
            ...
            <div>
                <asp:ListView ID="ListView4" runat="server" DataKeyNames="MaKH" DataSourceID="loadKH" InsertItemPosition="LastItem">
                    <AlternatingItemTemplate>
                        <td runat="server" style="background-color: #FAFAD2;color: #284775;">MaKH:
                    ...
                    <EditItemTemplate>
                        <td runat="server" style="background-color: #FFCC66;color: #000080;">MaKH:
                    ...
                    <InsertItemTemplate>
                        <td runat="server" style="background: pink">MaKH:<br />
                    ...
                    <ItemTemplate>
                        <td runat="server" style="background-color: #FFFBD6;color: #333333;">MaKH:
                            <asp:Label ID="MaKHLabel" runat="server" Text='<%# Eval("MaKH") %>' />
                            <br />
                            TenKH:
                            <asp:Label ID="TenKHLabel" runat="server" Text='<%# Eval("TenKH") %>' />
                    ...
                    <SelectedItemTemplate>
                        <td runat="server" style="background-color: #FFCC66;font-weight: bold;color: #000080;">MaKH:
                            <asp:Label ID="MaKHLabel" runat="server" Text='<%# Eval("MaKH") %>' />
                            <br />
                            TenKH:
                            <asp:Label ID="TenKHLabel" runat="server" Text='<%# Eval("TenKH") %>' />
            ...
            <div class="well">
                ...
                <div>
                    <asp:ListView ID="ListView3" runat="server" DataKeyNames="MaHD,MaSP" DataSourceID="LoadCTHD" InsertItemPosition="LastItem">
                        ...
                        <ItemTemplate>
                            <td runat="server" style="margin: 20px; padding-left: 25px;padding-right: 25px; border: 1px solid;">MaHD:
                                <asp:Label ID="MaHDLabel" runat="server" Text='<%# Eval("MaHD") %>' />
                                <br />
                                MaSP:
                                <asp:Label ID="MaSPLabel" runat="server" Text='<%# Eval("MaSP") %>' />
                        ...
                        <SelectedItemTemplate>
                            <td runat="server" style="padding-right: 50px">MaHD:
                                <asp:Label ID="MaHDLabel" runat="server" Text='<%# Eval("MaHD") %>' />
                                <br />
                                MaSP:
                                <asp:Label ID="MaSPLabel" runat="server" Text='<%# Eval("MaSP") %>' />
